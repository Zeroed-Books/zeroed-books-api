...
//!
//! use zeroed_books_api::client_ip::ClientIp;
//!
...
#![warn(clippy::all, missing_docs, nonstandard_style)]

use axum::{
    async_trait,
    extract::{ConnectInfo, FromRequestParts},
    http::{header::FORWARDED, request::Parts, HeaderMap, StatusCode},
};
    ...
    S: Send + Sync,
{
    ...
    async fn from_request_parts(parts: &mut Parts, _state: &S) -> Result<Self, Self::Rejection> {
        ...
        maybe_x_forwarded_for(headers)
            ...
            .or_else(|| maybe_connect_info(parts))
            .map(Self)
            .ok_or((
...
fn maybe_connect_info(parts: &Parts) -> Option<IpAddr> {
    parts
        .extensions
